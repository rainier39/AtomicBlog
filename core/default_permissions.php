...
define("PERM_UPLOAD", 32);
define("PERM_DELETE_POST", 64);
define("PERM_STAR_POST", 128);
define("PERM_PUBLISH_POST", 256);

// ** Moderator perms **
define("PERM_MOD_EDIT_POST", 512);
define("PERM_MOD_UPLOAD", 1024);
define("PERM_MOD_DELETE_POST", 2048);
// Mods can't star by default but this is something one may want to allow.
define("PERM_MOD_STAR_POST", 4096);

// ** Admin perms **
// Allows changing users' roles.
define("PERM_MANAGE_USERS", 8192);
// Allows configuring blog.
define("PERM_MANAGE_BLOG", 16384);

$permissions = array(
    "Owner" => PERM_VIEW_POST|PERM_VIEW_POSTS|PERM_LOGIN|PERM_NEW_POST|PERM_EDIT_POST|PERM_UPLOAD|PERM_DELETE_POST|PERM_STAR_POST|PERM_PUBLISH_POST|PERM_MOD_EDIT_POST|PERM_MOD_UPLOAD|PERM_MOD_DELETE_POST|PERM_MOD_STAR_POST|PERM_MANAGE_BLOG|PERM_MANAGE_USERS,
    "Moderator" => PERM_VIEW_POST|PERM_VIEW_POSTS|PERM_LOGIN|PERM_NEW_POST|PERM_EDIT_POST|PERM_UPLOAD|PERM_DELETE_POST|PERM_PUBLISH_POST|PERM_MOD_EDIT_POST|PERM_MOD_UPLOAD|PERM_MOD_DELETE_POST,
    "Author" => PERM_VIEW_POST|PERM_VIEW_POSTS|PERM_LOGIN|PERM_NEW_POST|PERM_EDIT_POST|PERM_UPLOAD|PERM_DELETE_POST|PERM_PUBLISH_POST,
