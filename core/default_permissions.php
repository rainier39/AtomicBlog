...
$permissions = array(
    "Owner" => PERM_VIEW_POST|PERM_VIEW_POSTS|PERM_COMMENT|PERM_EDIT_COMMENT|PERM_DELETE_COMMENT|PERM_LOGIN|PERM_NEW_POST|PERM_DELETE_POST|PERM_UPLOAD|PERM_STAR_POST|PERM_MOD_COMMENTS|PERM_MOD_EDIT_POST|PERM_MOD_UPLOAD|PERM_MOD_DELETE_POST|PERM_MOD_STAR_POST|PERM_MANAGE_BLOG|PERM_MANAGE_USERS,
    "Moderator" => PERM_VIEW_POST|PERM_VIEW_POSTS|PERM_COMMENT|PERM_EDIT_COMMENT|PERM_DELETE_COMMENT|PERM_LOGIN|PERM_NEW_POST|PERM_DELETE_POST|PERM_UPLOAD|PERM_MOD_COMMENTS|PERM_MOD_EDIT_POST|PERM_MOD_UPLOAD|PERM_MOD_DELETE_POST,
