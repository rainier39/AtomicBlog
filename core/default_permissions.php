...
$permissions = array(
    "Owner" => PERM_VIEW_POST|PERM_VIEW_POSTS|PERM_LOGIN|PERM_NEW_POST|PERM_EDIT_POST|PERM_UPLOAD|PERM_DELETE_POST|PERM_STAR_POST|PERM_PUBLISH_POST|PERM_MANAGE_BLOG|PERM_MANAGE_USERS,
    "Moderator" => PERM_VIEW_POST|PERM_VIEW_POSTS|PERM_LOGIN|PERM_NEW_POST|PERM_EDIT_POST|PERM_UPLOAD|PERM_DELETE_POST|PERM_PUBLISH_POST,
