...
if ($config["installed"]) {
    echo("<div class='navbar'><a href='/'>Home</a> <a href='/posts/'>Posts</a>" . ((isset($_SESSION["logged_in"]) && $_SESSION["logged_in"]) ? " <a href='/panel/'>Panel</a> <a href='/logout/'>Logout</a>" : " <a href='/login/'>Login</a> <a href='/register/'>Register</a>") . "</div>");
}
