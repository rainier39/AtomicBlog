# AtomicBlog
AtomicBlog is a simple, lightweight blogging software written purely in PHP along with HTML, CSS, and JavaScript. No libraries, no frameworks, minimal JavaScript. I originally wrote it while taking a communication studies class at college. I was supposed to create a blog as part of a semester long project in the class. It was expected that I would use some online service such as weebly for the task, but I decided to challenge myself and create my very own blogging software from scratch. It turned out to be a great decision, resulting in AtomicBlog existing now, and helping me gain experience and skills as a full-stack web developer.
